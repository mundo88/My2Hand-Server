    ...
    context = [
        {
            ...
            'attachment': 'https://plus.unsplash.com/premium_photo-1676717962720-d9a812c8f8c9?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8cHJvZHVjdHN8ZW58MHx8MHx8fDA%3D',
            'author': {
                'name': 'Minh Phùng',
                'profile_picture': 'https://phanmemmkt.vn/wp-content/uploads/2022/11/avatar-tet-2023-cute-31.jpg',
            },
            'time': f'{random.randint(1, 59)} phút trước',
            'content': '<p>Sản phẩm tự nhiên không chất bảo quản</p><p>😘😘😘</p>',
            'product': {
                'title': 'Nước dứa đóng chai tự nhiên',
                'price': 'đ136.000',
                'sold': random.randint(59, 1203)
            }
        }, {
            'url': 'https://cdn.dribbble.com',
            'attachment': 'https://images.unsplash.com/photo-1525904097878-94fb15835963?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjB8fHByb2R1Y3RzfGVufDB8fDB8fHww',
            'author': {
                'name': 'Le Thao Nguyen',
                'profile_picture': 'https://cdn.dribbble.com/users/626327/screenshots/3606928/snap_1x.gif',
            },
            'time': f'{random.randint(1, 59)} phút trước',
            'content': '<p>Sản phẩm tự nhiên không chất bảo quản</p><p>😘😘😘</p>',
            'product': {
            ...
            'url': 'https://cdn.dribbble.com',
            'attachment': 'https://images.unsplash.com/photo-1560769629-975ec94e6a86?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fHByb2R1Y3RzfGVufDB8fDB8fHww',
            'author': {
                'name': 'David Tran',
                'profile_picture': 'https://cdn.dribbble.com/users/1312595/screenshots/14134383/img_0057_1x.png',
            },
            'time': f'{random.randint(1, 59)} phút trước',
            'content': '<p>Sản phẩm tự nhiên không chất bảo quản</p><p>😘😘😘</p>',
            'product': {
            ...
            'url': 'https://cdn.dribbble.com',
            'attachment': 'https://images.unsplash.com/photo-1571781926291-c477ebfd024b?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8cHJvZHVjdHN8ZW58MHx8MHx8fDA%3D',
            'author': {
                'name': 'Sport Shop',
                'profile_picture': 'https://cdn.dribbble.com/users/1355613/screenshots/6317190/smoking_hot_1x.jpg',
            },
            'time': f'{random.randint(1, 59)} phút trước',
            'content': '<p>Sản phẩm tự nhiên không chất bảo quản</p><p>😘😘😘</p>',
            'product': {
            ...
            'url': 'https://cdn.dribbble.com',
            'attachment': 'https://images.unsplash.com/photo-1511556820780-d912e42b4980?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8cHJvZHVjdHN8ZW58MHx8MHx8fDA%3D',
            'author': {
                'name': 'Designer Longbong',
                'profile_picture': 'https://cdn.dribbble.com/users/515705/screenshots/9818728/leo-natsume-2020_1x.jpg',
            },
            'time': f'{random.randint(1, 59)} phút trước',
            'content': '<p>Sản phẩm tự nhiên không chất bảo quản</p><p>😘😘😘</p>',
            'product': {
            ...
            'url': 'https://cdn.dribbble.com',
            'attachment': 'https://images.unsplash.com/photo-1617005082133-548c4dd27f35?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDB8fHByb2R1Y3RzfGVufDB8fDB8fHww',
            'author': {
                'name': 'Dribbble Ngaos',
                'profile_picture': 'https://cdn.dribbble.com/users/237483/screenshots/2841978/pirateship_1x.png',
            },
            'time': f'{random.randint(1, 59)} phút trước',
            'content': '<p>Sản phẩm tự nhiên không chất bảo quản</p><p>😘😘😘</p>',
            'product': {
            ...
            'url': 'https://cdn.dribbble.com',
            'attachment': 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8cHJvZHVjdHN8ZW58MHx8MHx8fDA%3D',
            'author': {
                'name': 'Pham Nhu',
                'profile_picture': 'https://cdn.dribbble.com/users/31752/screenshots/3567301/toucan_1x.jpg',
            },
            'time': f'{random.randint(1, 59)} phút trước',
            'content': '<p>Sản phẩm tự nhiên không chất bảo quản</p><p>😘😘😘</p>',
            'product': {
            ...
            'url': 'https://cdn.dribbble.com',
            'attachment': 'https://images.unsplash.com/photo-1612188842101-f976582906fc?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDd8fHByb2R1Y3RzfGVufDB8fDB8fHww',
            'author': {
                'name': 'Đặng Lê Nguyên Vũ',
                'profile_picture': 'https://cdn.dribbble.com/users/59947/screenshots/9737825/muti_2_1x.jpg',
            },
            'time': f'{random.randint(1, 59)} phút trước',
            'content': '<p>Sản phẩm tự nhiên không chất bảo quản</p><p>😘😘😘</p>',
            'product': {
            ...
            'url': 'https://cdn.dribbble.com',
            'attachment': 'https://images.unsplash.com/photo-1550547660-d9450f859349?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NjN8fHByb2R1Y3RzfGVufDB8fDB8fHww',
            'author': {
                'name': 'Hoàng Sao',
                'profile_picture': 'https://cdn.dribbble.com/users/39185/screenshots/2448264/ghost_1x.jpg',
            },
            'time': f'{random.randint(1, 59)} phút trước',
            'content': '<p>Sản phẩm tự nhiên không chất bảo quản</p><p>😘😘😘</p>',
            'product': {
            ...
            'url': 'https://cdn.dribbble.com',
            'attachment': 'https://images.unsplash.com/photo-1522273400909-fd1a8f77637e?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8ODB8fHByb2R1Y3RzfGVufDB8fDB8fHww',
            'author': {
                'name': 'Human',
                'profile_picture': 'https://cdn.dribbble.com/users/164119/screenshots/5251711/art_090518_dribbble-01_1x.jpg',
            },
            'time': f'{random.randint(1, 59)} phút trước',
            'content': '<p>Sản phẩm tự nhiên không chất bảo quản 😘😘😘</p><p>Mua ngay để nhận được giá ưu đãi !!!</p>',
            'product': {
                'title': 'Nước dứa đóng chai tự nhiên',
                'price': 'đ136.000',
                'sold': random.randint(59, 1203)
...
def categories(request):
    context = [
        {
            'img': 'https://cdn.dribbble.com/users/59138/screenshots/2766478/untitled-10_1x.gif',
            'text': 'Quần áo',
            'url': '/clothes'
        }, {
            'img': 'https://cdn.dribbble.com/users/1044993/screenshots/6892368/rooster_dribbble_1x.png',
            'text': 'Điện tử',
            'url': '/device'
        }, {
            'img': 'https://cdn.dribbble.com/users/1925451/screenshots/4017216/workspacee_3_1x.jpg',
            'text': 'Máy tính',
            'url': '/clothes'
        }, {
            'img': 'https://cdn.dribbble.com/users/3178178/screenshots/12293842/travelers_by_patryk_wojciechowicz_1x.jpg',
            'text': 'Máy ảnh',
            'url': '/device'
        }, {
            'img': 'https://cdn.dribbble.com/users/1787323/screenshots/10716439/panda_eat_bamboo-02_1x.png',
            'text': 'Đồng hồ',
            'url': '/clothes'
        }, {
            'img': 'https://cdn.dribbble.com/users/772985/screenshots/5294822/clay_1x.jpg',
            'text': 'Giày dép',
            'url': '/device'
        }, {
            'img': 'https://cdn.dribbble.com/users/1355613/screenshots/6383382/detective_1x.jpg',
            'text': 'Thể thao',
            'url': '/clothes'
        }, {
            'img': 'https://cdn.dribbble.com/users/59947/screenshots/6703315/muti-1_1x.jpg',
            'text': 'Làm đẹp',
            'url': '/device'
        }, {
            'img': 'https://cdn.dribbble.com/users/1077075/screenshots/3838933/chameleon_1x.png',
            'text': 'Sách báo',
            'url': '/clothes'
        }, {
            'img': 'https://cdn.dribbble.com/users/59138/screenshots/2766478/untitled-10_1x.gif',
